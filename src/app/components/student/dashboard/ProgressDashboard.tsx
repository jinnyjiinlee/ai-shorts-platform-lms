...
import { fetchStudentDashboardData } from '../../../../lib/services/dashboard/studentDashboardService';
                ...
                <div className="flex items-end justify-between">
                  ...
                  <div className="flex items-center space-x-1">
                    {[...Array(Math.min(5, stats.completedMissions))].map((_, i) => (
                      <div key={i} className="w-2 h-8 bg-gradient-to-t from-blue-500 to-indigo-500 rounded-full" 
