...
export default function ProfileActions({ isSaving, onSave, showToast }: any) {
  return <>
    ...
    {showToast && <div className='fixed top-4 right-4 z-50'><div className='bg-green-500 text-white px-6 py-4 rounded-lg shadow-lg flex items-center space-x-3'><CheckIcon className='w-6 h-6' /><span>저장 완료!</span></div></div>}
  </>;
}