    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 
      ...
      <div className='w-full max-w-sm sm:max-w-md bg-white/90 backdrop-blur-sm 
        ...
        <div className="text-center mb-5 sm:mb-6 landscape:mb-4">
          <h1 className='text-xl sm:text-2xl font-bold text-slate-800 mb-2 sm:mb-3 landscape:mb-2'>
            프로필 정보 입력
          </h1>
          <p className='text-sm sm:text-base text-slate-600 leading-relaxed px-2 landscape:text-sm'>
            서비스 이용을 위해<br className="sm:hidden"/> 추가 정보를 입력해주세요
          </p>
        </div>
          ...
          <div>
            ...
            <p className="mt-2 text-xs sm:text-sm text-slate-600">
              <span className="inline-flex items-center">
                ...
                <span className="leading-relaxed">현재 1기 진행중입니다</span>
              </span>
            </p>
          </div>
