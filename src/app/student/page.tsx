import ProgressDashboard from '@/features/student/dashboard/ProgressDashboard';
...
//         <StudentSidebar activeMenu={activeMenu} onMenuClick={setActiveMenu} className='h-full' />
//       </div>
