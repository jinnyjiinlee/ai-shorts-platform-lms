...
const MISSION_CARD_CLASS =
  'bg-white border border-slate-200 rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-200 hover:border-slate-300';
  ...
  return (
    <div className='space-y-5'>
      {missions.map((mission) => (
        <div key={mission.id} className={MISSION_CARD_CLASS}>
          <div className='flex items-start justify-between'>
            ...
            <div className='flex-1 mr-6'>
              ...
              <div className='flex items-center space-x-3 mb-3'>
                ...
                {getStatusBadge ? (
                  getStatusBadge(mission.status, mission.isSubmitted)
                ) : (
                  <span
