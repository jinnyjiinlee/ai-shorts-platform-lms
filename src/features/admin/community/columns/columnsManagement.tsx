      ...
      {showForm && (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50'>
          <div className='bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto'>
            <div className='p-6 border-b border-slate-200'>
              <h3 className='text-xl font-semibold text-slate-900'>{editingColumn ? '칼럼 수정' : '새 칼럼 작성'}</h3>
            </div>
          ...
          <div className='bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[80vh] overflow-y-auto'>
            <div className='p-6 border-b border-slate-200'>
              <div className='flex justify-between items-start'>
                ...
                <button onClick={() => setViewingColumn(null)} className='text-slate-400 hover:text-slate-600'>
