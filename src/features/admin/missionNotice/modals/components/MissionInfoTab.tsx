        ...
        <div className='prose prose-slate max-w-none bg-white border border-slate-200 rounded-lg p-4'>
          <ReactMarkdown
            components={{
              ...
              p: ({ children }) => (
                <p className='mb-3 text-slate-600 leading-relaxed whitespace-pre-wrap'>{children}</p>
              ),
              ul: ({ children }) => <ul className='list-disc list-inside mb-3 text-slate-600 space-y-1'>{children}</ul>,
              ol: ({ children }) => (
                <ol className='list-decimal list-inside mb-3 text-slate-600 space-y-1'>{children}</ol>
              ),
