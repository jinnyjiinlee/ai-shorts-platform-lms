...
interface AiContentsStudioProps {
  userRole: 'admin' | 'student';
}

export default function AiContentsStudio({ userRole }: AiContentsStudioProps) {
  const aiTools = [
    {
              ...
              <div className='relative bg-white/90 backdrop-blur-sm rounded-3xl p-6 border border-white/40 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden'>
                ...
                <div className='relative z-10'>
                  <div className='flex items-center justify-between mb-4'>
                    ...
                    {tool.comingSoon ? (
                      <div className='px-4 py-2 bg-gray-400 text-white text-sm font-semibold rounded-full flex items-center space-x-2 cursor-not-allowed opacity-70'>
                        <span>나중에 공개</span>
