import { WeeklyData, StudentSubmissionDetail } from '@/features/admin/MissionTracking/trackingService';
    ...
    <div className='min-w-max'>
      ...
      <div className='sticky top-0 bg-white border-b border-slate-200 pb-2 mb-4'>
        <div className='grid grid-cols-[200px_repeat(auto-fit,_100px)_100px] gap-2'>
          ...
          {weeklyData.map((week) => (
            <div key={week.missionId} className='font-semibold text-slate-900 text-xs p-2 text-center'>
              {week.week}주차
            </div>
          ))}
        ...
        {allStudents.map((student) => {
          ...
          return (
            <div
              ...
              className='grid grid-cols-[200px_repeat(auto-fit,_100px)_100px] gap-2 hover:bg-slate-50 rounded-lg p-2'
            >
              ...
              {weeklyData.map((week) => {
                ...
                return (
                  <div key={week.missionId} className='text-center'>
                    <button
                      onClick={() =>
                        hasSubmission &&
                        onSubmissionClick({
              ...
              <div
                className={`text-center text-sm font-medium ${
                  submissionRate >= 80 ? 'text-green-600' : submissionRate >= 60 ? 'text-blue-600' : 'text-red-600'
                }`}
              >
                {submissionRate}%
              </div>
